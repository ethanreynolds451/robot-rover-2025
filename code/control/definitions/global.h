...
static const uint8_t pwm_min = 0;          // Minimum PWM value to overcome motor deadzone
static const uint8_t pwm_max = 255;         // Maximum PWM value to prevent overvoltage to motor driver
