...
class Metaclass_GetSerialPort(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vehicle_interfaces.srv.GetSerialPort')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vehicle_interfaces.srv import _get_serial_port
...
class GetSerialPort(metaclass=Metaclass_GetSerialPort):
    from vehicle_interfaces.srv._get_serial_port import GetSerialPort_Request as Request
    from vehicle_interfaces.srv._get_serial_port import GetSerialPort_Response as Response
