...
bool vehicle_interfaces__srv__get_serial_device_status__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.srv._get_serial_device_status.GetSerialDeviceStatus_Request", full_classname_dest, 78) == 0);
  }
  vehicle_interfaces__srv__GetSerialDeviceStatus_Request * ros_message = _ros_message;
  {  // device
...
{
  /* NOTE(esteve): Call constructor of GetSerialDeviceStatus_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.srv._get_serial_device_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetSerialDeviceStatus_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool vehicle_interfaces__srv__get_serial_device_status__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.srv._get_serial_device_status.GetSerialDeviceStatus_Response", full_classname_dest, 79) == 0);
  }
  vehicle_interfaces__srv__GetSerialDeviceStatus_Response * ros_message = _ros_message;
  {  // port
...
{
  /* NOTE(esteve): Call constructor of GetSerialDeviceStatus_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.srv._get_serial_device_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetSerialDeviceStatus_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
