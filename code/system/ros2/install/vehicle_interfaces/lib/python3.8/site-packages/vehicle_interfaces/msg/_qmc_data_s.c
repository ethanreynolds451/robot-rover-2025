...
bool vehicle_interfaces__msg__qmc_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.msg._qmc_data.QMCData", full_classname_dest, 40) == 0);
  }
  vehicle_interfaces__msg__QMCData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of QMCData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.msg._qmc_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "QMCData");
