...
bool vehicle_interfaces__srv__get_device_status__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.srv._get_device_status.GetDeviceStatus_Request", full_classname_dest, 65) == 0);
  }
  vehicle_interfaces__srv__GetDeviceStatus_Request * ros_message = _ros_message;
  {  // device
...
PyObject * vehicle_interfaces__srv__get_device_status__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.srv._get_device_status");
...
ROSIDL_GENERATOR_C_EXPORT
bool vehicle_interfaces__srv__get_device_status__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.srv._get_device_status.GetDeviceStatus_Response", full_classname_dest, 66) == 0);
  }
  vehicle_interfaces__srv__GetDeviceStatus_Response * ros_message = _ros_message;
  {  // port
