...
#include <stddef.h>
#include "vehicle_interfaces/srv/detail/get_device_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vehicle_interfaces__srv__GetDeviceStatus_Request__init(message_memory);
}
...
{
  vehicle_interfaces__srv__GetDeviceStatus_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetDeviceStatus_Request__rosidl_typesupport_introspection_c__GetDeviceStatus_Request_message_member_array[1] = {
  {
    ...
    offsetof(vehicle_interfaces__srv__GetDeviceStatus_Request, device),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDeviceStatus_Request__rosidl_typesupport_introspection_c__GetDeviceStatus_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(vehicle_interfaces__srv__GetDeviceStatus_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetDeviceStatus_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  vehicle_interfaces__srv__GetDeviceStatus_Response__init(message_memory);
}
...
{
  vehicle_interfaces__srv__GetDeviceStatus_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetDeviceStatus_Response__rosidl_typesupport_introspection_c__GetDeviceStatus_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces__srv__GetDeviceStatus_Response, port),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces__srv__GetDeviceStatus_Response, connected),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDeviceStatus_Response__rosidl_typesupport_introspection_c__GetDeviceStatus_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(vehicle_interfaces__srv__GetDeviceStatus_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_vehicle_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetDeviceStatus_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_members = {
  "vehicle_interfaces__srv",  // service namespace
  "GetDeviceStatus",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_Request_message_type_support_handle,
  NULL  // response message
  // vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_Response_message_type_support_handle
};

static rosidl_service_type_support_t vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_type_support_handle = {
  0,
  &vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetDeviceStatus)() {
  if (!vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_type_support_handle.typesupport_identifier) {
    vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetDeviceStatus_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetDeviceStatus_Response)()->data;
  }

  return &vehicle_interfaces__srv__detail__get_device_status__rosidl_typesupport_introspection_c__GetDeviceStatus_service_type_support_handle;
}
