...
{
  new (message_memory) vehicle_interfaces::msg::IRData(_init);
}

void IRData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vehicle_interfaces::msg::IRData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IRData_message_member_array[5] = {
  {
    ...
    offsetof(vehicle_interfaces::msg::IRData, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces::msg::IRData, address),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces::msg::IRData, command),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces::msg::IRData, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<vehicle_interfaces::msg::IRData>()
{
  return &::vehicle_interfaces::msg::rosidl_typesupport_introspection_cpp::IRData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_interfaces, msg, IRData)() {
  return &::vehicle_interfaces::msg::rosidl_typesupport_introspection_cpp::IRData_message_type_support_handle;
}
