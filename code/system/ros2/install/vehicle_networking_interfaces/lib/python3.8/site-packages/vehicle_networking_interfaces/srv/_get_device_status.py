...
class Metaclass_GetDeviceStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vehicle_networking_interfaces.srv.GetDeviceStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vehicle_networking_interfaces.srv import _get_device_status
...
class GetDeviceStatus(metaclass=Metaclass_GetDeviceStatus):
    from vehicle_networking_interfaces.srv._get_device_status import GetDeviceStatus_Request as Request
    from vehicle_networking_interfaces.srv._get_device_status import GetDeviceStatus_Response as Response
