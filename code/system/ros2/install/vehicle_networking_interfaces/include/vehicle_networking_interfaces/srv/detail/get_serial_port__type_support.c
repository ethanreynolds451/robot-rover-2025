...
#include <stddef.h>
#include "vehicle_networking_interfaces/srv/detail/get_serial_port__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vehicle_networking_interfaces__srv__GetSerialPort_Request__init(message_memory);
}

void GetSerialPort_Request__rosidl_typesupport_introspection_c__GetSerialPort_Request_fini_function(void * message_memory)
{
  vehicle_networking_interfaces__srv__GetSerialPort_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetSerialPort_Request__rosidl_typesupport_introspection_c__GetSerialPort_Request_message_member_array[1] = {
  {
    ...
    offsetof(vehicle_networking_interfaces__srv__GetSerialPort_Request, device),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers GetSerialPort_Request__rosidl_typesupport_introspection_c__GetSerialPort_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(vehicle_networking_interfaces__srv__GetSerialPort_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_networking_interfaces, srv, GetSerialPort_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  vehicle_networking_interfaces__srv__GetSerialPort_Response__init(message_memory);
}
...
{
  vehicle_networking_interfaces__srv__GetSerialPort_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetSerialPort_Response__rosidl_typesupport_introspection_c__GetSerialPort_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_networking_interfaces__srv__GetSerialPort_Response, port),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetSerialPort_Response__rosidl_typesupport_introspection_c__GetSerialPort_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(vehicle_networking_interfaces__srv__GetSerialPort_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_vehicle_networking_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_networking_interfaces, srv, GetSerialPort_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_members = {
  "vehicle_networking_interfaces__srv",  // service namespace
  "GetSerialPort",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_Request_message_type_support_handle,
  NULL  // response message
  // vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_Response_message_type_support_handle
};

static rosidl_service_type_support_t vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_type_support_handle = {
  0,
  &vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_networking_interfaces, srv, GetSerialPort)() {
  if (!vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_type_support_handle.typesupport_identifier) {
    vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_networking_interfaces, srv, GetSerialPort_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_networking_interfaces, srv, GetSerialPort_Response)()->data;
  }

  return &vehicle_networking_interfaces__srv__detail__get_serial_port__rosidl_typesupport_introspection_c__GetSerialPort_service_type_support_handle;
}
