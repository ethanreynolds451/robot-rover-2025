...
static const _ResetSerialPort_Request_type_support_symbol_names_t _ResetSerialPort_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, ResetSerialPort_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, ResetSerialPort_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_interfaces, srv, ResetSerialPort_Request)() {
  return &::vehicle_interfaces::srv::rosidl_typesupport_c::ResetSerialPort_Request_message_type_support_handle;
}
...
static const _ResetSerialPort_Response_type_support_symbol_names_t _ResetSerialPort_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, ResetSerialPort_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, ResetSerialPort_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_vehicle_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_interfaces, srv, ResetSerialPort_Response)() {
  return &::vehicle_interfaces::srv::rosidl_typesupport_c::ResetSerialPort_Response_message_type_support_handle;
}
...
static const _ResetSerialPort_type_support_symbol_names_t _ResetSerialPort_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, ResetSerialPort)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, ResetSerialPort)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_interfaces, srv, ResetSerialPort)() {
  return &::vehicle_interfaces::srv::rosidl_typesupport_c::ResetSerialPort_service_type_support_handle;
}
