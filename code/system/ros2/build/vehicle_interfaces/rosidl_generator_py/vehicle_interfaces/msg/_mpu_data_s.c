...
bool vehicle_interfaces__msg__mpu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.msg._mpu_data.MPUData", full_classname_dest, 40) == 0);
  }
  vehicle_interfaces__msg__MPUData * ros_message = _ros_message;
  {  // header
  ...
  {  // is_valid
    ...
    if (!std_msgs__msg__bool__convert_from_py(field, &ros_message->is_valid)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // temp
    ...
    if (!sensor_msgs__msg__temperature__convert_from_py(field, &ros_message->temp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of MPUData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.msg._mpu_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MPUData");
  ...
  {  // is_valid
    PyObject * field = NULL;
    field = std_msgs__msg__bool__convert_to_py(&ros_message->is_valid);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // temp
    PyObject * field = NULL;
    field = sensor_msgs__msg__temperature__convert_to_py(&ros_message->temp);
    if (!field) {
      return NULL;
    }
    {
