...
bool vehicle_interfaces__msg__gps_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.msg._gps_data.GPSData", full_classname_dest, 40) == 0);
  }
  vehicle_interfaces__msg__GPSData * ros_message = _ros_message;
  {  // header
  ...
  {  // speed_kmph
    PyObject * field = PyObject_GetAttrString(_pymsg, "speed_kmph");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
...
PyObject * vehicle_interfaces__msg__gps_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.msg._gps_data");
  ...
  {  // speed_kmph
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->speed_kmph);
    {
      int rc = PyObject_SetAttrString(_pymessage, "speed_kmph", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
