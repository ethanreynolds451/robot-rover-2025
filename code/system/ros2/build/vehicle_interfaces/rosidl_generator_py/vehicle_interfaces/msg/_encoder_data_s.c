...
bool vehicle_interfaces__msg__encoder_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.msg._encoder_data.EncoderData", full_classname_dest, 48) == 0);
  }
  vehicle_interfaces__msg__EncoderData * ros_message = _ros_message;
  {  // header
...
PyObject * vehicle_interfaces__msg__encoder_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.msg._encoder_data");
