...
bool vehicle_interfaces__msg__ultrasonic_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_interfaces.msg._ultrasonic_data.UltrasonicData", full_classname_dest, 54) == 0);
  }
  vehicle_interfaces__msg__UltrasonicData * ros_message = _ros_message;
  {  // header
...
PyObject * vehicle_interfaces__msg__ultrasonic_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_interfaces.msg._ultrasonic_data");
