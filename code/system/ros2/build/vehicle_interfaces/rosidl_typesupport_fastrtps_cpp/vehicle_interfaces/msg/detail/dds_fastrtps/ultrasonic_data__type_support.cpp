...
#include "vehicle_interfaces/msg/detail/ultrasonic_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_interfaces::msg::UltrasonicData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_interfaces::msg::UltrasonicData & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const vehicle_interfaces::msg::UltrasonicData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_interfaces::msg::UltrasonicData *>(
    untyped_ros_message);
...
static size_t _UltrasonicData__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_UltrasonicData(full_bounded, 0);
}
...
{
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_UltrasonicData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_interfaces, msg, UltrasonicData)() {
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_UltrasonicData__handle;
}
