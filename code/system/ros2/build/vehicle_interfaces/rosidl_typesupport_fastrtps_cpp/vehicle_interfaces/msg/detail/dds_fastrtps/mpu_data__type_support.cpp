...
#include "vehicle_interfaces/msg/detail/mpu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_interfaces::msg::MPUData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_interfaces::msg::MPUData & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const vehicle_interfaces::msg::MPUData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_interfaces::msg::MPUData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MPUData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vehicle_interfaces::msg::MPUData *>(
...
{
  return max_serialized_size_MPUData(full_bounded, 0);
}

static message_type_support_callbacks_t _MPUData__callbacks = {
...
static rosidl_message_type_support_t _MPUData__handle = {
...
{
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_MPUData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_interfaces, msg, MPUData)() {
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_MPUData__handle;
}
