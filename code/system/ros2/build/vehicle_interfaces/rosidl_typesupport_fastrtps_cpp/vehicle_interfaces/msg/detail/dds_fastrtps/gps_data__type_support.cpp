...
#include "vehicle_interfaces/msg/detail/gps_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_interfaces::msg::GPSData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_interfaces::msg::GPSData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: sats
  {
    size_t item_size = sizeof(ros_message.sats);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const vehicle_interfaces::msg::GPSData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_interfaces::msg::GPSData *>(
    untyped_ros_message);
...
static size_t _GPSData__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GPSData(full_bounded, 0);
}
...
{
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_GPSData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_interfaces, msg, GPSData)() {
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_GPSData__handle;
}
