...
#include "vehicle_interfaces/msg/detail/encoder_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_interfaces::msg::EncoderData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_interfaces::msg::EncoderData & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const vehicle_interfaces::msg::EncoderData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_interfaces::msg::EncoderData *>(
    untyped_ros_message);
...
{
  return max_serialized_size_EncoderData(full_bounded, 0);
}
...
{
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_EncoderData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_interfaces, msg, EncoderData)() {
  return &vehicle_interfaces::msg::typesupport_fastrtps_cpp::_EncoderData__handle;
}
