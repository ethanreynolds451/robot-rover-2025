...
void UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  vehicle_interfaces__msg__UltrasonicData__init(message_memory);
}

void UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_message_member_array[3] = {
  {
    ...
    offsetof(vehicle_interfaces__msg__UltrasonicData, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces__msg__UltrasonicData, is_valid),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces__msg__UltrasonicData, range),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_message_members = {
  ...
  UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_message_type_support_handle = {
  0,
  &UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, msg, UltrasonicData)() {
  UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_message_member_array[0].members_ =
  ...
  return &UltrasonicData__rosidl_typesupport_introspection_c__UltrasonicData_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
