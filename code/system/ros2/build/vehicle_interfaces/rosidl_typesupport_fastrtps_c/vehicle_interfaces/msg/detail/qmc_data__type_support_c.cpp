...
#include "vehicle_interfaces/msg/detail/qmc_data__rosidl_typesupport_fastrtps_c.h"
...
using _QMCData__ros_msg_type = vehicle_interfaces__msg__QMCData;

static bool _QMCData__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _QMCData__ros_msg_type * ros_message = static_cast<const _QMCData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _QMCData__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _QMCData__ros_msg_type * ros_message = static_cast<_QMCData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _QMCData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__msg__QMCData(
...
static size_t _QMCData__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_vehicle_interfaces__msg__QMCData(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_QMCData = {
  "vehicle_interfaces::msg",
  "QMCData",
  _QMCData__cdr_serialize,
  _QMCData__cdr_deserialize,
  _QMCData__get_serialized_size,
  _QMCData__max_serialized_size
};

static rosidl_message_type_support_t _QMCData__type_support = {
