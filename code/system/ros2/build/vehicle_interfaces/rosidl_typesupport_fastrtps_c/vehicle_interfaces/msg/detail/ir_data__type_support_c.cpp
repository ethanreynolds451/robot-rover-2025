...
#include "vehicle_interfaces/msg/detail/ir_data__rosidl_typesupport_fastrtps_c.h"
...
using _IRData__ros_msg_type = vehicle_interfaces__msg__IRData;
...
static uint32_t _IRData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__msg__IRData(
...
{
  return max_serialized_size_vehicle_interfaces__msg__IRData(
    full_bounded, 0);
}
