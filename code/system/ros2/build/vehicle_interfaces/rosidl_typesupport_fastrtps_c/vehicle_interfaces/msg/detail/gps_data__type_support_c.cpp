...
#include "vehicle_interfaces/msg/detail/gps_data__rosidl_typesupport_fastrtps_c.h"
...
using _GPSData__ros_msg_type = vehicle_interfaces__msg__GPSData;
...
static uint32_t _GPSData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__msg__GPSData(
...
{
  return max_serialized_size_vehicle_interfaces__msg__GPSData(
    full_bounded, 0);
}
