...
#include "vehicle_interfaces/msg/detail/mpu_data__rosidl_typesupport_fastrtps_c.h"
...
using _MPUData__ros_msg_type = vehicle_interfaces__msg__MPUData;

static bool _MPUData__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MPUData__ros_msg_type * ros_message = static_cast<const _MPUData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _MPUData__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MPUData__ros_msg_type * ros_message = static_cast<_MPUData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _MPUData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__msg__MPUData(
...
static size_t _MPUData__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_vehicle_interfaces__msg__MPUData(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MPUData = {
  "vehicle_interfaces::msg",
  "MPUData",
  _MPUData__cdr_serialize,
  _MPUData__cdr_deserialize,
  _MPUData__get_serialized_size,
  _MPUData__max_serialized_size
};

static rosidl_message_type_support_t _MPUData__type_support = {
