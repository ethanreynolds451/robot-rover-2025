...
#include "vehicle_interfaces/msg/detail/to_f_data__rosidl_typesupport_fastrtps_c.h"
...
using _ToFData__ros_msg_type = vehicle_interfaces__msg__ToFData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ToFData__ros_msg_type * ros_message = static_cast<const _ToFData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ToFData__ros_msg_type * ros_message = static_cast<_ToFData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ToFData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__msg__ToFData(
...
{
  return max_serialized_size_vehicle_interfaces__msg__ToFData(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ToFData = {
...
static rosidl_message_type_support_t _ToFData__type_support = {
