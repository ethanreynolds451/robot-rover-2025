...
#include "vehicle_interfaces/msg/detail/ultrasonic_data__rosidl_typesupport_fastrtps_c.h"
...
using _UltrasonicData__ros_msg_type = vehicle_interfaces__msg__UltrasonicData;
...
static uint32_t _UltrasonicData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__msg__UltrasonicData(
...
{
  return max_serialized_size_vehicle_interfaces__msg__UltrasonicData(
    full_bounded, 0);
}
