...
#ifndef VEHICLE_INTERFACES__SRV__DETAIL__GET_SERIAL_PORT__FUNCTIONS_H_
#define VEHICLE_INTERFACES__SRV__DETAIL__GET_SERIAL_PORT__FUNCTIONS_H_
 ...
 * calls
 * vehicle_interfaces__srv__GetSerialPort_Request__init().
...
/**
 * It calls
 * vehicle_interfaces__srv__GetSerialPort_Request__fini()
 ...
 * vehicle_interfaces__srv__GetSerialPort_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vehicle_interfaces__srv__GetSerialPort_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vehicle_interfaces__srv__GetSerialPort_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vehicle_interfaces
...
/**
 * It calls
 * vehicle_interfaces__srv__GetSerialPort_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vehicle_interfaces
...
/**
 * It allocates the memory for the array and calls
 * vehicle_interfaces__srv__GetSerialPort_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vehicle_interfaces
...
/**
 * It calls
 * vehicle_interfaces__srv__GetSerialPort_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VEHICLE_INTERFACES__SRV__DETAIL__GET_SERIAL_PORT__FUNCTIONS_H_
