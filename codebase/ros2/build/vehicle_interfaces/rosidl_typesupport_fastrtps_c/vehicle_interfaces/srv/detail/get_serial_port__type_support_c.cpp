...
#include "vehicle_interfaces/srv/detail/get_serial_port__rosidl_typesupport_fastrtps_c.h"
...
using _GetSerialPort_Request__ros_msg_type = vehicle_interfaces__srv__GetSerialPort_Request;
...
size_t get_serialized_size_vehicle_interfaces__srv__GetSerialPort_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetSerialPort_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__srv__GetSerialPort_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_interfaces
size_t max_serialized_size_vehicle_interfaces__srv__GetSerialPort_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_vehicle_interfaces__srv__GetSerialPort_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, GetSerialPort_Request)() {
...
using _GetSerialPort_Response__ros_msg_type = vehicle_interfaces__srv__GetSerialPort_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_interfaces
size_t get_serialized_size_vehicle_interfaces__srv__GetSerialPort_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSerialPort_Response__ros_msg_type * ros_message = static_cast<const _GetSerialPort_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interfaces__srv__GetSerialPort_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_interfaces
size_t max_serialized_size_vehicle_interfaces__srv__GetSerialPort_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_vehicle_interfaces__srv__GetSerialPort_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, GetSerialPort_Response)() {
...
// already included above
// #include "vehicle_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "vehicle_interfaces/srv/get_serial_port.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, GetSerialPort)() {
