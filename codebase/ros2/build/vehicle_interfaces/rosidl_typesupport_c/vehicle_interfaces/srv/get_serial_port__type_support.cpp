...
static const _GetSerialPort_Request_type_support_symbol_names_t _GetSerialPort_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, GetSerialPort_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetSerialPort_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_interfaces, srv, GetSerialPort_Request)() {
  return &::vehicle_interfaces::srv::rosidl_typesupport_c::GetSerialPort_Request_message_type_support_handle;
}
...
static const _GetSerialPort_Response_type_support_symbol_names_t _GetSerialPort_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, GetSerialPort_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetSerialPort_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_vehicle_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_interfaces, srv, GetSerialPort_Response)() {
  return &::vehicle_interfaces::srv::rosidl_typesupport_c::GetSerialPort_Response_message_type_support_handle;
}
...
static const _GetSerialPort_type_support_symbol_names_t _GetSerialPort_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interfaces, srv, GetSerialPort)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_interfaces, srv, GetSerialPort)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vehicle_interfaces, srv, GetSerialPort)() {
  return &::vehicle_interfaces::srv::rosidl_typesupport_c::GetSerialPort_service_type_support_handle;
}
