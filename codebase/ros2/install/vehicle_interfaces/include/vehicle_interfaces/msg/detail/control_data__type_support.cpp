...
{
  new (message_memory) vehicle_interfaces::msg::ControlData(_init);
}

void ControlData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vehicle_interfaces::msg::ControlData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlData_message_member_array[8] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces::msg::ControlData, brake),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_interfaces::msg::ControlData, shift_up),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::vehicle_interfaces::msg::rosidl_typesupport_introspection_cpp::ControlData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_interfaces, msg, ControlData)() {
  return &::vehicle_interfaces::msg::rosidl_typesupport_introspection_cpp::ControlData_message_type_support_handle;
}
